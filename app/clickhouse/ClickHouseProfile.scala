...
trait ClickHouseProfile extends JdbcProfile {
  ...
  override def createTableDDLBuilder(table: Table[_]): TableDDLBuilderCH = new TableDDLBuilderCH(table)
  ...
  trait ClickHouseAPI extends API {
    ...
    implicit def chSingleColumnQueryExtensionMethods[B1: BaseTypedType, C[_]](
                                                                               q: Query[Rep[B1], _, C]): CHSingleColumnQueryExtensionMethods[B1, B1, C] =
    ...
    implicit def chSingleOptionColumnQueryExtensionMethods[B1: BaseTypedType, C[_]](
        q: Query[Rep[Option[B1]], _, C]): CHSingleColumnQueryExtensionMethods[B1, Option[B1], C] =
      new CHSingleColumnQueryExtensionMethods[B1, Option[B1], C](q)
    implicit def chColumnExtensionMethods[B1](c: Rep[B1])(
        implicit tm: BaseTypedType[B1] /* with NumericTypedType*/ )
      : BaseCHColumnExtensionMethods[B1] = new BaseCHColumnExtensionMethods[B1](c)
    implicit def chOptionColumnExtensionMethods[B1](c: Rep[Option[B1]])(
        implicit tm: BaseTypedType[B1] /* with NumericTypedType*/ )
