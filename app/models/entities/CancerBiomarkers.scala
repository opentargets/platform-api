...
case class CancerBiomarkerSource(description: Option[String],
                                 link: Option[String],
                                 name: Option[String])
...
case class CancerBiomarker(id: String,
                           ...
                           target: String,
                           sources: Seq[CancerBiomarkerSource],
                           pubmedIds: Seq[Long])

case class CancerBiomarkers(uniqueDrugs: Long,
                            uniqueDiseases: Long,
...
object CancerBiomarkers {
  ...
  implicit val cancerBiomarkerSourceImpR: Reads[models.entities.CancerBiomarkerSource] =
    ((JsPath \ "description").readNullable[String] and
      ...
      (JsPath \ "name").readNullable[String])(CancerBiomarkerSource.apply _)
  ...
  implicit val cancerBiomarkerImpR: Reads[models.entities.CancerBiomarker] =
    ((JsPath \ "id").read[String] and
      ...
      (JsPath \ "sourcesOther").readWithDefault[Seq[CancerBiomarkerSource]](Seq.empty) and
      (JsPath \ "sourcesPubmed").readWithDefault[Seq[Long]](Seq.empty))(CancerBiomarker.apply _)
