...
object Configuration {
  ...
  case class PharmacogenomicsSettings(drug: DbTableSettings,
                                      variant: DbTableSettings,
                                      target: DbTableSettings
  )
  ...
  implicit val pharmacogenomicsSettingsJSONImp: OFormat[PharmacogenomicsSettings] =
