  ...
  val evidenceImp = ObjectType(
    ...
    fields[Backend, JsValue](
      ...
      Field(
        ...
        resolve = js => (js.value \ "confidenceIntervalLower").asOpt[Double]
      ),
      ...
      Field("clinicalUrls",
            ...
            description = None,
            resolve = js => (js.value \ "clinicalUrls").asOpt[Seq[JsValue]]),
      Field("literature",
            OptionType(ListType(StringType)),
            description = None,
      ...
      Field("pathwayName",
            OptionType(StringType),
            description = None,
            resolve = js => (js.value \ "pathwayName").asOpt[String]),
      Field("datasourceId",
            StringType,
            description = None,
      ...
      Field("confidenceIntervalUpper",
            OptionType(FloatType),
            description = None,
            resolve = js => (js.value \ "confidenceIntervalUpper").asOpt[Double]),
      ...
      Field("pValueMantissa",
            OptionType(LongType),
            description = None,
            resolve = js => (js.value \ "pValueMantissa").asOpt[Long]),
      Field("pathwayId",
            OptionType(StringType),
            description = None,
            resolve = js => (js.value \ "pathwayId").asOpt[String]),
