...
object Evidence {
  ...
  val evidenceVariationImp = ObjectType("EvidenceVariation",
    ...
    fields[Backend, JsValue](
      ...
      Field("inheritancePattern", OptionType(StringType), description = None, resolve = js => (js.value \ "inheritancePattern").asOpt[String]),
      Field("variantAminoacidDescription", OptionType(StringType), description = None, resolve = js => (js.value \ "variantAminoacidDescription").asOpt[String]),
  ...
  val evidenceImp = ObjectType("Evidence",
    ...
    fields[Backend, JsValue](
      ...
      Field("variations", OptionType(ListType(evidenceVariationImp)), description = None, resolve = js => (js.value \ "variations").asOpt[Seq[JsValue]]),
