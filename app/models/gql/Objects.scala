...
object Objects extends Logging {
  ...
  val evidenceImp = ObjectType("Evidence",
    ...
    fields[Backend, JsValue](
      ...
      Field("evidenceVariantFunctionalConsequenceId", OptionType(StringType), description = None, resolve = js => (js.value \ "evidenceVariantFunctionalConsequenceId").asOpt[String]),
      ...
      Field("evidenceResourceScoreMantissa", OptionType(LongType), description = None, resolve = js => (js.value \ "evidenceResourceScoreMantissa").asOpt[Long]),
